...
If improvising for [____tonight____](http://darkroomretreat.com/format/#tonight): use many layers. With each layer, block as much light as close to the source as possible. First, block 99% the light. Then 99% of what's left. Then the last 0.01% is easier to address or ignore. Close any curtains in rooms or hallways outside a darkroom's door. Where possible, prevent direct sunlight from hitting your darkening measures with shade. 
